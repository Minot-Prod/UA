# Parlios Build Prompt — Boostify

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **Boostify**, branded Parlios, using insights from `/research/boostify_report.md` if available.
...
- At build time, incorporate best practices from `/research/boostify_report.md` (if present)
