# Parlios Build Prompt — Base44 Dashboard

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **Base44 Dashboard**, branded Parlios, using insights from `/research/base44_dashboard_report.md` if available.
...
- At build time, incorporate best practices from `/research/base44_dashboard_report.md` (if present)
