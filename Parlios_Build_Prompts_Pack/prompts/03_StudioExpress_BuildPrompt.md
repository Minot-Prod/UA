# Parlios Build Prompt — Studio Express

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **Studio Express**, branded Parlios, using insights from `/research/studio_express_report.md` if available.
...
- At build time, incorporate best practices from `/research/studio_express_report.md` (if present)
