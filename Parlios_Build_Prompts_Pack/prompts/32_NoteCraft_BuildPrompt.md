# Parlios Build Prompt — NoteCraft

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **NoteCraft**, branded Parlios, using insights from `/research/notecraft_report.md` if available.
...
- At build time, incorporate best practices from `/research/notecraft_report.md` (if present)
