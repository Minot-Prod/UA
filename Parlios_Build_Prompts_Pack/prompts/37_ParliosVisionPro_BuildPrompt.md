# Parlios Build Prompt — Parlios Vision Pro

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **Parlios Vision Pro**, branded Parlios, using insights from `/research/parlios_vision_pro_report.md` if available.
...
- At build time, incorporate best practices from `/research/parlios_vision_pro_report.md` (if present)
