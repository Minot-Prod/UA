# Parlios Build Prompt — PromoPulse

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **PromoPulse**, branded Parlios, using insights from `/research/promopulse_report.md` if available.
