# Parlios Build Prompt — ClientFlow

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **ClientFlow**, branded Parlios, using insights from `/research/clientflow_report.md` if available.
...
- At build time, incorporate best practices from `/research/clientflow_report.md` (if present)
