# Parlios Build Prompt — SectionStack

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **SectionStack**, branded Parlios, using insights from `/research/sectionstack_report.md` if available.
...
- At build time, incorporate best practices from `/research/sectionstack_report.md` (if present)
