# Parlios Build Prompt — ArticleCraft Lite

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **ArticleCraft Lite**, branded Parlios, using insights from `/research/articlecraft_lite_report.md` if available.
...
- At build time, incorporate best practices from `/research/articlecraft_lite_report.md` (if present)
