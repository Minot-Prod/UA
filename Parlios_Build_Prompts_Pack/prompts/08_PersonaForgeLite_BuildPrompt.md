# Parlios Build Prompt — PersonaForge Lite

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **PersonaForge Lite**, branded Parlios, using insights from `/research/personaforge_lite_report.md` if available.
...
- At build time, incorporate best practices from `/research/personaforge_lite_report.md` (if present)
