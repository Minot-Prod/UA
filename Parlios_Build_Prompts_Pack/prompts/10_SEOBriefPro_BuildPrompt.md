# Parlios Build Prompt — SEOBrief Pro

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **SEOBrief Pro**, branded Parlios, using insights from `/research/seobrief_pro_report.md` if available.
...
- At build time, incorporate best practices from `/research/seobrief_pro_report.md` (if present)
