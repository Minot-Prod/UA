# Parlios Build Prompt — GodKo Video Studio

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **GodKo Video Studio**, branded Parlios, using insights from `/research/godko_video_studio_report.md` if available.
...
- At build time, incorporate best practices from `/research/godko_video_studio_report.md` (if present)
