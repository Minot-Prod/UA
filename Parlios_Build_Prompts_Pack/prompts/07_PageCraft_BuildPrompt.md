# Parlios Build Prompt — PageCraft

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **PageCraft**, branded Parlios, using insights from `/research/pagecraft_report.md` if available.
...
- At build time, incorporate best practices from `/research/pagecraft_report.md` (if present)
