# Parlios Build Prompt — Parlios Hub Preview

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **Parlios Hub Preview**, branded Parlios, using insights from `/research/parlios_hub_preview_report.md` if available.
...
- At build time, incorporate best practices from `/research/parlios_hub_preview_report.md` (if present)
