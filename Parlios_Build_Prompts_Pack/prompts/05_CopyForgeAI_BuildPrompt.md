# Parlios Build Prompt — CopyForge AI

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **CopyForge AI**, branded Parlios, using insights from `/research/copyforge_ai_report.md` if available.
...
- At build time, incorporate best practices from `/research/copyforge_ai_report.md` (if present)
