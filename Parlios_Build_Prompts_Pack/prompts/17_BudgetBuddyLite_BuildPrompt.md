# Parlios Build Prompt — BudgetBuddy Lite

You are a world-class front-end engineering squad specializing in **front-only** AI tools (no backend, no external APIs). Build a **Netlify Drop-ready** preview of **BudgetBuddy Lite**, branded Parlios, using insights from `/research/budgetbuddy_lite_report.md` if available.
...
- At build time, incorporate best practices from `/research/budgetbuddy_lite_report.md` (if present)
