...
const navigationItems = [
  ...
  {
    name: "AI Allocation",
    url: createPageUrl("AIAllocation"),
    icon: Brain,
  },
];
      ...
      <nav className="bg-black/80 backdrop-blur-xl border-b border-slate-700/30 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Settings */}
            <button className="nav-pill w-10 h-10 rounded-lg bg-slate-800/70 border border-slate-700/60 flex items-center justify-center text-slate-300 hover:text-white">
